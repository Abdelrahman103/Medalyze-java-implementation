error id: file://<HOME>/projects/Medalyze-java-implementation/Deliverable%20%231/medalyze/src/main/java/com/medalyze/Main.java:_empty_/DatabaseConnection#
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        DatabaseConnection db2 = DatabaseConn@@ection.getInstance();
